...
namespace InkeServer.DataMapping
{
    ...
    public partial class Bus_BalanceChange
    {
        public string BalanceChange_ID { get; set; }
        public string Card_ID { get; set; }
        public string Card_BusinessID { get; set; }
        public int BusinessClass { get; set; }
        public string Record_ID { get; set; }
        public Nullable<decimal> CashAdd { get; set; }
        public Nullable<decimal> CashReduce { get; set; }
