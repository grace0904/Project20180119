...
using InkeServer.API.Areas.HelpPage.ModelDescriptions;
using System.Collections.Generic;
using System.IO;

namespace InkeServer.API.Areas.HelpPage
{
    /// <summary>
    ...
    public class XmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider
    {
        ...
        public XmlDocumentationProvider(string documentPath)
        {
            ...
            var files = new[] { "InkeServer.API.xml", "InkeServer.Model.xml", "Inke.Common.xml" };
